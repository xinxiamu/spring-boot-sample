...
public class TeacherStudents extends TableImpl<TeacherStudentsRecord> {
    ...
    private static final long serialVersionUID = 1479325922;
    ...
    public TeacherStudents() {
        this(DSL.name("teacher_students"), null);
    }
    ...
    public TeacherStudents(String alias) {
        this(DSL.name(alias), TEACHER_STUDENTS);
    }

    /**
     * Create an aliased <code>testDb.teacher_students</code> table reference
     */
    public TeacherStudents(Name alias) {
        this(alias, TEACHER_STUDENTS);
    }

    private TeacherStudents(Name alias, Table<TeacherStudentsRecord> aliased) {
        this(alias, aliased, null);
    }

    private TeacherStudents(Name alias, Table<TeacherStudentsRecord> aliased, Field<?>[] parameters) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TEACHER_STUDENTS_FKHSTOJ4YEP9M2VR6WH8CVQ1UPF, Indexes.TEACHER_STUDENTS_FKKR9RJNME1KLPD0O8SNOCE0124);
    }
    ...
    public TeacherStudents as(String alias) {
        return new TeacherStudents(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TeacherStudents as(Name alias) {
    ...
    public TeacherStudents rename(String name) {
        return new TeacherStudents(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TeacherStudents rename(Name name) {
